...
# URL from which to download the latest COCO trained weights  下载最新COCO训练重量的URL
...
def extract_bboxes(mask):
    """Compute bounding boxes from masks.从遮罩计算边界框。
...
def compute_iou(box, boxes, box_area, boxes_area):
    """Calculates IoU of the given box with the array of the given boxes.使用给定框的数组计算给定框的IoU。
...
# TODO: Build and use this function to reduce code duplication构建并使用此函数来减少代码重复
